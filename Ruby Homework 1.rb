...
#Завдання 2. Створити просту програму на Ruby, яка виконує основні арифметичні дії, такі як додавання, віднімання,
...
#Завдання 3. Потрібно знайти коректний , який допоможе імплементувати наступний функціонал
